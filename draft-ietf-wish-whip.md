...
WHIP sessions that support Trickle ICE MUST return a strong ETag as per {{Section 8.8.3 of !RFC9110}} in a successful response to a POST to the WHIP endpoint. WHIP clients that support Trickle ICE MUST use the ETag as per {{Section 13.1.1 of !RFC9110}} in its PATCH requests. Missing our outdated ETags in the PATCH requests from WHIP clients will be answered by WHIP sessions as per {{Section 13.1.1 of !RFC9110}} and {{Section 3 of !RFC6585}}.
